...
void XPUQuantizationParametersPropagationPass::Apply(
  ...
  // TODO(quwei):Check whether it is necessary in XPU.
  ...
  //   bool found = true;
  //   do {
  //     found = SetOutScaleFromCurInScale(graph,
  //     in_scale_same_as_out_scale_ops);
  //     SetInScaleFromPrevOutScale(graph);
  //   } while (found);
  //   do {
  //     found = SetInScaleFromCurOutScale(graph,
  //     in_scale_same_as_out_scale_ops);
  //     SetOutScaleFromNextInScale(graph, auto_complete_quant_scale_level);
  //   } while (found);
  // }
  // // (f) Complete the output scale according to the formula of some special
  // // ops
  // // themselves.
